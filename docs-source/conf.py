...
latex_elements = {
    ...
    #
    # 'figure_align': 'htbp',
    'classoptions': ',openany,oneside' # Remove blank pages at end of chapters
}
...
man_pages = [
    (master_doc, 'pybnf', 'PyBNF Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'PyBNF', 'PyBNF Documentation',
     author, 'PyBNF', 'One line description of project.',
     'Miscellaneous'),
]
